...
use fbe::field_model_collections::{FieldModelVectorString, FieldModelVectorStringMut, FieldModelArrayString, FieldModelArrayStringMut};
...
fn test_field_model_vector_string() {
    ...
    let values = vec!["Hello".to_string(), "Panilux".to_string(), "FBE".to_string()];
